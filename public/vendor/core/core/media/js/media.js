...
var Helpers = /*#__PURE__*/function () {
  ...
  return _createClass(Helpers, null, [{
    ...
    value: function addToRecent(id) {
      ...
      $httpClient.make().post(RV_MEDIA_URL.global_actions, {
        action: 'add_recent',
        item: fileData
      }).then(function (_ref) {
        var data = _ref.data;
    ...
    value: function handlePreview() {
      ...
      _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_2__.Helpers.each(_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_2__.Helpers.getSelectedFiles(), function (value) {
        if (value.preview_url) {
          ...
          _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_2__.Helpers.addToRecent(value.id);
        }
      });
...
var FolderService = /*#__PURE__*/function () {
  ...
  return _createClass(FolderService, [{
    ...
    key: "changeFolderAndAddToRecent",
    value: function changeFolderAndAddToRecent(folderId) {
      if (folderId > 0) {
        _Helpers_Helpers__WEBPACK_IMPORTED_MODULE_3__.Helpers.addToRecent(folderId, true);
      }
    ...
    value: function handleMediaList() {
      ...
      _self.$body.off('click', '.js-media-list-title').on('click', '.js-media-list-title', function (event) {
        ...
        if (!$current.data('is_folder')) {
          _App_Helpers_Helpers__WEBPACK_IMPORTED_MODULE_2__.Helpers.addToRecent($current.data('id'));
        }
