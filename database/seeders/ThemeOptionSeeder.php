...
class ThemeOptionSeeder extends BaseSeeder
{
    ...
    public function run(): void
    {
        ...
        $this->createThemeOptions([
            'site_title' => 'Bs-Derma - Minimal eCommerce',
            'seo_description' => 'Bs-Derma is a modern and flexible Minimal eCommerce Laravel script. This script is suited for electronic, organic and grocery store, furniture store, clothing store, hitech store and accessories store...',
            ...
            'social_links' => [
                ...
                [
                    ...
                    ['key' => 'icon', 'value' => 'ti ti-brand-behance'],
