...
register_sidebar([
    'id' => 'floating_social_sidebar',
    'name' => __('Floating Social Media'),
    'description' => __('Floating social media icons displayed on mobile'),
]);
...
app()->booted(function (): void {
    ...
    if (is_plugin_active('ads')) {
        AdsForm::extend(function (AdsForm $form) {
            ...
            $getMetaDataSafely = function ($key, $default = '') use ($model) {
                try {
                    $value = $model->getMetaData($key, true);
            ...
            return $form
                ->addAfter('name', 'subtitle', 'textarea', [
                    'label' => __('Subtitle'),
                    'value' => $getMetaDataSafely('subtitle', ''),
                    'attr' => [
                        'rows' => 2,
                    ],
                    'metadata' => true,
    ...
    PageForm::extend(function (PageForm $form) {
        ...
        return $form
            ...
            ->addAfter('banner_image', 'customize_footer', 'customSelect', [
                ...
                'selected' => $getMetaDataSafely('customize_footer', 'inherit'),
                'metadata' => true,
            ])
            ->addAfter('customize_footer', 'footer_background_color', 'customColor', [
                'label' => __('Footer background color'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_background_color', theme_option('footer_background_color', '#040404')),
                'metadata' => true,
            ])
            ->addAfter('footer_background_color', 'footer_text_color', 'customColor', [
                'label' => __('Footer text color'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_text_color', theme_option('footer_text_color', '#fff')),
                'metadata' => true,
            ])
            ->addAfter('footer_text_color', 'footer_text_muted_color', 'customColor', [
                'label' => __('Footer text muted color'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_text_muted_color', theme_option('footer_text_muted_color', '#a0a0a0')),
                'metadata' => true,
            ])
            ->addAfter('footer_text_muted_color', 'footer_logo', 'mediaImage', [
                'label' => __('Footer logo'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_logo', theme_option('logo_light')),
                'metadata' => true,
            ])
            ->addAfter('footer_logo', 'footer_border_color', 'customColor', [
                'label' => __('Footer border color'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_border_color', theme_option('footer_border_color', '#282828')),
                'metadata' => true,
            ])
            ->addAfter('footer_border_color', 'footer_bottom_background_color', 'customColor', [
                'label' => __('Footer bottom background color'),
                'label_attr' => ['class' => 'control-label'],
                'value' => $getMetaDataSafely('footer_bottom_background_color', theme_option('footer_bottom_background_color', '#040404')),
                'metadata' => true,
            ]);
    }, 127);
