<div class="navigation-bar">
    <ul class="navigation-bar__list">
        <li>
            <a href="{{ BaseHelper::getHomepageUrl() }}" class="text-truncate" title="{{ __('Home') }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="mobile-tab-icon">
        ...
        <li>
            <a role="button" href="javascript:void(0)" class="tp-categories-sidebar-toggle text-truncate"
                title="{{ __('Categories') }}">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="mobile-tab-icon">
                    <path stroke-linecap="round" stroke-linejoin="round"
        ...
        @if (EcommerceHelper::isCartEnabled())
            <li>
                <a role="button" href="javascript:void(0)" class="tp-cart-toggle text-truncate"
                    title="{{ __('Cart') }}">
            ...
            <li>
                <a href="{{ route('public.wishlist') }}" class="text-truncate" title="{{ __('Wishlist') }}">
                    <div class="header-cart p-relative">
                        ...
                        <span class="tp-product-count tp-product-wishlist-count text-white"
                            style="inset-inline-end: 2px">{{ Cart::instance('wishlist')->count() }}</span>
                    </div>
                    @if ($showMenuLabel)
